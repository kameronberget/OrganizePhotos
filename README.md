...
| OrganizeBy | True | String [TabComplete] | This parameters defines how you want the final structure to be organized. *See below for examples*
...
*When using the OrganizeBy parameter, your output formats are listed below:
